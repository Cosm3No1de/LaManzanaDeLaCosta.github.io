...
(function($){
	...
	app.masVendidos = function(){
		var productos = [
			{
				id : 1,
				img : 'assets/img/Iphon11-removebg-preview.png',
				name : 'iPhone 11 64GB',
				price : 580.00,
				desc : 'iPhone 11 de 64gb de almacenamiento,Pantalla: 6.1", 828 x 1792 pixels · Procesador: Apple A13 Bionic · RAM: 4GB  ',
				stock : 3
			},
			{
				id : 2,
				name : 'iPhone 13 de 128GB ',
				img : 'assets/img/iPHONE 13.jpg',
				price : 860.00,
				desc : 'Pantalla: 6.1", 1170 x 2532 pixels · Procesador: Apple A15 Bionic · Almacenamiento: 128GB/256GB/512GB',
				stock : 2
			},
			{
				id : 3,
				name : 'iPhone 14 PLUS 256GB',
				img : 'assets/img/Iphone_14PlusUltimo-removebg-preview.png',
				price : 850.00,
			...
			},
			{
				...
				img : 'assets/img/Iphone 14 PRO.jpg',
				price : 1280.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 4
			},
			{
				...
				img : 'assets/img/iPHONE13 pRO mAX.jpeg',
				price : 1180.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 4
			},
			{
				...
				img : 'assets/img/iphone_11_128gb_ult-removebg-preview.png',
				price : 680.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 1
			},
			...
			{
				id : 8,
				name : 'Cabezal Apple 20watt tipo C',
				img : 'assets/img/Cabezal 20watt.jpg',
				price : 80.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 20
			},
			{
				id : 9,
				name : 'Cable USB Lightning',
				img : 'assets/img/cable-usb-apple.jpg',
				price : 50.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 16
			}
